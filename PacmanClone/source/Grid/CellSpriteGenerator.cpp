...
CellSpriteAlignment CellSpriteGenerator::GetCellAlignment(std::shared_ptr<GridCell> Cell)
{
	...
	for (int i = 0; i < 4; i++)
	{
		if (Cell->Links[i]->Target->bIsWalkable)
			Walkability += 2 ^ i;
	}
	...
	bool NEWalkable = Cell->Links[0]->Target->Links[2]->Target->bIsWalkable;
	bool NWWalkable = Cell->Links[0]->Target->Links[3]->Target->bIsWalkable;
	bool SEWalkable = Cell->Links[1]->Target->Links[2]->Target->bIsWalkable;
	bool SWWalkable = Cell->Links[1]->Target->Links[3]->Target->bIsWalkable;
